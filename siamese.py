...
with open('./positive_pairs.pkl','rb') as file:
...
with open('./negative_pairs.pkl','rb') as file:
...
# torch.save(model.state_dict() , "siamese_weights.pt")

# end_time = time.time()

# print("Trainig time = ", end_time - start_time, " seconds")

model.load_state_dict(torch.load("siamese_weights.pt"))
model.eval()
