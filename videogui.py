...
def load_frames():
	...
	if os.path.exists(path) :
		...
		if full.get() :
			...
			items = (sort_dir(os.listdir(path))[:finalframe])
...
def videoplay():
	...
	if t2-t1 !=0 and currentframe - cf != 0:
		...
		print((currentframe-cf)/(t2-t1),"fps")
...
l = add_listbox(hgt=190,wdt=500,x1=10,y1=140)
sy = Scrollbar()
sy.place(x=200,y=140,height=500,width=10)
